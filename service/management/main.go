...
import (
	...
	"gitlab.com/annoying-orange/shenzhouyinji/service/management/config"
	h "gitlab.com/annoying-orange/shenzhouyinji/service/management/handler"
	pb "gitlab.com/annoying-orange/shenzhouyinji/service/management/proto"
	r "gitlab.com/annoying-orange/shenzhouyinji/service/management/repository"
)
...
func main() {
	...
	if err := pb.RegisterManagementServiceHandler(srv.Server(), &h.Handler{Repository: repo}); err != nil {
		logger.Fatal(err)
	}
