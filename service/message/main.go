...
import (
	...
	"gitlab.com/annoying-orange/shenzhouyinji/service/message/config"
	h "gitlab.com/annoying-orange/shenzhouyinji/service/message/handler"
	pb "gitlab.com/annoying-orange/shenzhouyinji/service/message/proto"
	r "gitlab.com/annoying-orange/shenzhouyinji/service/message/repository"
)
...
func main() {
	...
	if err := pb.RegisterMessagesServiceHandler(srv.Server(), &h.Handler{Repository: repo}); err != nil {
		logger.Fatal(err)
	}
