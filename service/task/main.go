...
import (
	...
	"gitlab.com/annoying-orange/shenzhouyinji/service/task/config"
	h "gitlab.com/annoying-orange/shenzhouyinji/service/task/handler"
	pb "gitlab.com/annoying-orange/shenzhouyinji/service/task/proto"
	r "gitlab.com/annoying-orange/shenzhouyinji/service/task/repository"
)
...
func main() {
	...
	if err := pb.RegisterTaskServiceHandler(srv.Server(), &h.Handler{Repository: repo}); err != nil {
		logger.Fatal(err)
	}
