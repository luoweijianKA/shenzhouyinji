...
import (
	...
	"gitlab.com/annoying-orange/shenzhouyinji/service/event/config"
	h "gitlab.com/annoying-orange/shenzhouyinji/service/event/handler"
	pb "gitlab.com/annoying-orange/shenzhouyinji/service/event/proto"
	r "gitlab.com/annoying-orange/shenzhouyinji/service/event/repository"
)
...
func main() {
	...
	if err := pb.RegisterEventServiceHandler(srv.Server(), &h.Handler{Repository: repo}); err != nil {
		logger.Fatal(err)
	}
