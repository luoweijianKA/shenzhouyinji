...
import (
	...
	"gitlab.com/annoying-orange/shenzhouyinji/service/account/config"
	h "gitlab.com/annoying-orange/shenzhouyinji/service/account/handler"
...
func main() {
	...
	if err := pb.RegisterAccountServiceHandler(srv.Server(), &h.Handler{Repository: repo}); err != nil {
		logger.Fatal(err)
	}
