...
func (r *mutationResolver) UpdateConfigs(ctx context.Context, input map[string]interface{}) (map[string]interface{}, error) {
	data := []*mPB.Config{}
	for k, v := range input {
...
func (r *mutationResolver) UpdateEventSettings(ctx context.Context, id string, settings map[string]interface{}) (map[string]interface{}, error) {
