...
func (r *queryResolver) Accounts(ctx context.Context, first *int, after *string, last *int, before *string, search *string) (*model.AccountConnection, error) {
	ctx, cancel := context.WithTimeout(ctx, 10*time.Second)
	defer cancel()
...
func (r *queryResolver) Configs(ctx context.Context) (map[string]interface{}, error) {
...
func (r *queryResolver) UserIdentityAuthDetail(ctx context.Context, flowID string) (map[string]interface{}, error) {
	ctx, cancel := context.WithTimeout(ctx, 10*time.Second)
	defer cancel()
...
func (r *queryResolver) EventSettings(ctx context.Context, id string) (map[string]interface{}, error) {
...
func (r *queryResolver) WeRunData(ctx context.Context, encryptedData string, iv string) (map[string]interface{}, error) {
